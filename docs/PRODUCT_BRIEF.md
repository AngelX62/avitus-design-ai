...
Avitus is not measured by how many AI features it has.

Avitus is measured by whether it helps property businesses recover, protect, and convert more opportunities from leads they already have.

North Star outcome:

Property businesses should know which opportunities are worth money, why they matter, what is missing, what action should happen next, and what requires owner approval.

The strongest product moment is:

Messy leads, old spreadsheet rows, stale opportunities, or past-client records go in.
...
- missing information
- overdue follow-ups
- stale leads worth reactivating
- past clients worth checking in with
- prepared drafts for owner review

The emotional product promise is:

Avitus helps owners stop losing valuable opportunities hidden inside messy lead data.
...
### Internal Tier Value Framing

The commercial tiers should be understood by business outcome, not just feature access.

- Foundation = Lead Control System
- Signature = AI Opportunity Recovery Engine
- Bespoke = Custom Revenue Engine

These labels clarify the value of each tier:

Foundation helps owners get control over messy leads, scattered inquiries, reminders, statuses, and basic revenue-risk signals.

Signature helps owners recover more opportunities through AI qualification, Avara, explainable scoring, missing-information detection, stale lead detection, recommended next actions, and prepared follow-ups.

Bespoke connects Avitus into the client’s operating system through integrations, custom routing, approval-based external workflows, reactivation campaigns, and bespoke revenue workflows.

These internal labels should guide product positioning and pricing, but they do not change the implementation order.
...
Foundation should not feel like a basic lead tracker.
...
Do not add AI-generated scoring, AI-written follow-up drafts, autonomous outreach, CRM sync, WhatsApp/email/SMS sending, or advanced automation to Foundation. Those belong to Signature or Bespoke.
...
### Vertical-Aware Recommended Next Actions

Avitus should not use generic next actions.

Recommended next actions should reflect the studio’s vertical, qualification profile, lead fields, score breakdown, missing information, and current lead status.

For interior design studios, next actions should consider project type, property type, budget fit, timeline, location, scope clarity, style preference, consultation readiness, proposal status, and site visit readiness.

For real estate teams, next actions should consider buyer/seller/renter/investor type, property type, location preference, budget or property value, financing readiness, viewing readiness, listing readiness, seller motivation, and timeline urgency.

Recommended next actions should help the owner answer:

- What should I do next?
- Why does this lead matter?
- What information is missing?
- What opportunity might be lost if I ignore this?

Do not hardcode vertical-specific next actions directly in UI components. Vertical-aware next actions should come from the Studio Qualification Profile, Prompt Packs, lead fields, scoring weights, and Lead Intelligence Service.
...
### Studio Preference Calibration

Avara should start with vertical intelligence, then adapt to each studio’s actual approval patterns over time.

Avara should learn from repeated owner behavior, including approved leads, rejected leads, prioritized leads, ignored leads, owner score/classification corrections, won leads, lost leads, and edited follow-up drafts.

This is not silent black-box learning. One owner action is not enough to change scoring or recommendations.

Repeated patterns should produce explainable calibration insights such as:

- “This studio often prioritizes full-home projects above this budget range.”
- “This owner often marks urgent timeline leads as Hot.”
- “This studio usually rejects low-budget single-room inquiries.”
- “This real estate team prioritizes buyers with clear financing.”

Avara should use these patterns to improve lead scoring, missing-information priority, recommended next actions, Priority Leads, and follow-up tone.

Owner approval or review should be required before stable preferences update the Studio Qualification Profile.
...
### Budget Conversation Preference

Avitus should not treat missing budget as an automatic low-fit signal.

Some studios want to qualify budget early. Other studios prefer to discuss pricing only after scope, style, consultation readiness, or project expectations are clearer.

The Studio Qualification Profile should support a `budget_conversation_style` preference.

Allowed values:
- `direct`: ask for budget or investment range early.
- `soft_discovery`: ask gently about expected investment range.
- `consultation_first`: do not ask for price directly in the first follow-up; flag budget as missing for the owner.
- `education_first`: guide the client toward realistic budget expectations based on scope before asking for a number.

This preference should affect:
- missing information priority
- recommended next action
- follow-up draft tone
- lead score explanation
- Avara’s answer when budget is missing

Missing budget should usually mean “needs budget clarification,” not “bad lead.”
...
V1.1 recommended next actions must be vertical-aware, not generic. They should use the Studio Qualification Profile, Prompt Packs, vertical-specific lead fields, score breakdown, missing information, and current lead status.
...
Avitus should prove value through operational and revenue-adjacent metrics.

Track:

- time from lead received to first owner action
- number of hot or high-fit leads identified
- number of follow-ups due or overdue
- number of stale leads surfaced
- number of stale leads reactivated
- number of prepared drafts copied, edited, or approved
- number of owner corrections captured
- number of leads converted to won projects/deals
- estimated opportunity value surfaced where budget/value is available

Do not claim revenue lift unless it is backed by customer data.

The first business proof is not “AI accuracy.” The first business proof is that Avitus helps owners act faster on better opportunities.
...
A pilot is successful if Avitus shows measurable improvement in at least one of these:

- faster first response time
- more follow-ups completed
- more stale leads surfaced
- more high-fit leads identified
- more old leads reactivated
- more prepared drafts used
- more leads moved from New/Needs Review to Contacted/Consultation/Won
- estimated opportunity value surfaced from existing lead data

The pilot should prove that Avitus helps owners act faster on better opportunities.
